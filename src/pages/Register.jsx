...
export default function Register() {
  ...
  return (
    ...
    >
      <div className="bg-gray-800 bg-opacity-95 p-8 rounded-2xl w-full max-w-md shadow-xl">
        <img
          src={logoRickMorty}
          alt="Rick and Morty"
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="bg-green-400 text-gray-900 font-bold py-3 rounded-lg hover:bg-green-300 transition-colors"
          >
            Cadastrar
          </button>
        </form>
